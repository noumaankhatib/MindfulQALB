        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={() => !savingEntity && setEditingBooking(null)}>
          <div className="bg-white rounded-2xl border border-lavender-200 shadow-xl max-w-lg w-full p-6 max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-4">
              ...
              {editingBooking.meeting_url && (
                <div className="p-3 bg-blue-50 border border-blue-200 rounded-xl">
                  <label className="block text-sm font-medium text-blue-700 mb-1.5">Google Meet Link</label>
                  <div className="flex items-center gap-2">
                    <a
                      href={editingBooking.meeting_url}
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        navigator.clipboard.writeText(editingBooking.meeting_url!);
                      }}
                      className="px-2.5 py-1.5 text-xs font-medium text-blue-700 bg-blue-100 hover:bg-blue-200 rounded-lg transition-colors flex-shrink-0"
                    >
                      Copy
                    </button>
                  </div>
